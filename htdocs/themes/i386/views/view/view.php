	...
	<div class="row">
		<div class="span12">
			...
			<?php if($expire > 0){?><span class="detail by"><?php echo sprintf(lang('paste_expire'), random_expire_msg()); ?> <?php echo timespan(time(), $expire, 1); ?>.</span><?php } ?>
					<?php if(isset($inreply) && is_array($inreply)){?><div class="detail by"><?php echo lang('paste_isareply'); ?> <a href="<?php echo $inreply['url']?>"><?php echo $inreply['title']; ?></a> <?php echo strtolower(lang('paste_from')); ?> <?php echo $inreply['name']; ?>
<?php if($seg3 != 'diff'){ ?>
...
<section>
	<div class="row">
		<div class="span12">
			<blockquote class="hero-unit" id="code"><?php echo $paste; ?></blockquote>
		</div>
	</div>
</section>
